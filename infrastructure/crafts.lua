...
-- Asphalt block
	minetest.register_craft({
		type = "cooking",
		output = '"infrastructure:asphalt" 3',
...
-- Concrete block
	minetest.register_craft({
		type = "cooking",
		output = '"infrastructure:concrete" 3',
...
-- Concrete fence
	minetest.register_craft({
		output = '"infrastructure:fence_concrete" 6',
		recipe = {
...
-- Asphalt block with yield triangular line
	minetest.register_craft({
		output = '"infrastructure:asphalt_yield_triangular" 9',
		recipe = {
			{'wool:white', 'infrastructure:asphalt', 'wool:white'},
			{'infrastructure:asphalt', 'wool:white', 'infrastructure:asphalt'},
			{'infrastructure:asphalt', 'infrastructure:asphalt', 'infrastructure:asphalt'}
		}
	})
...
-- Asphalt block with yield rectangular line
	minetest.register_craft({
		output = '"infrastructure:asphalt_yield_rectangular" 9',
		recipe = {
			{'wool:white', 'infrastructure:asphalt', 'wool:white'},
			{'infrastructure:asphalt', 'infrastructure:asphalt', 'infrastructure:asphalt'},
			{'infrastructure:asphalt', 'infrastructure:asphalt', 'infrastructure:asphalt'}
...
-- Asphalt block with stop line
	minetest.register_craft({
		output = '"infrastructure:asphalt_stop" 9',
		recipe = {
			{'wool:white', 'wool:white', 'wool:white'},
			{'infrastructure:asphalt', 'infrastructure:asphalt', 'infrastructure:asphalt'},
			{'infrastructure:asphalt', 'infrastructure:asphalt', 'infrastructure:asphalt'}
...
-- Asphalt block with speed breaker line
	minetest.register_craft({
		output = '"infrastructure:asphalt_speed_breaker" 9',
		recipe = {
			{'wool:white', 'infrastructure:asphalt', 'wool:white'},
			{'wool:white', 'infrastructure:asphalt', 'wool:white'},
			{'infrastructure:asphalt', 'infrastructure:asphalt', 'wool:white'}
		}
	})

-- Asphalt block with pedestrian crossing line
	minetest.register_craft({
		output = '"infrastructure:asphalt_pedestrian_crossing" 9',
		recipe = {
			{'wool:white', 'wool:white', 'infrastructure:asphalt'},
			{'wool:white', 'wool:white', 'infrastructure:asphalt'},
			{'wool:white', 'wool:white', 'infrastructure:asphalt'}
		}
	})
...
-- Asphalt block with arrow straight
	minetest.register_craft({
		output = '"infrastructure:asphalt_arrow_straight" 9',
		recipe = {
			{'infrastructure:asphalt', 'wool:white', 'infrastructure:asphalt'},
			{'infrastructure:asphalt', 'wool:white', 'infrastructure:asphalt'},
			{'infrastructure:asphalt', 'wool:white', 'infrastructure:asphalt'}
...
-- Asphalt block with arrow straight + left
	minetest.register_craft({
		output = '"infrastructure:asphalt_arrow_straight_left" 9',
		recipe = {
			{'infrastructure:asphalt', 'wool:white', 'infrastructure:asphalt'},
			{'wool:white', 'wool:white', 'infrastructure:asphalt'},
			{'infrastructure:asphalt', 'wool:white', 'infrastructure:asphalt'}
...
-- Asphalt block with arrow straight + right
	minetest.register_craft({
		output = '"infrastructure:asphalt_arrow_straight_right" 9',
		recipe = {
			{'infrastructure:asphalt', 'wool:white', 'infrastructure:asphalt'},
			{'infrastructure:asphalt', 'wool:white', 'wool:white'},
			{'infrastructure:asphalt', 'wool:white', 'infrastructure:asphalt'}
		}
	})
...
-- Asphalt block with arrow left
	minetest.register_craft({
		output = '"infrastructure:asphalt_arrow_left" 9',
		recipe = {
			{'infrastructure:asphalt', 'infrastructure:asphalt', 'infrastructure:asphalt'},
			{'wool:white', 'wool:white', 'infrastructure:asphalt'},
			{'infrastructure:asphalt', 'wool:white', 'infrastructure:asphalt'}
...
-- Asphalt block with arrow right
	minetest.register_craft({
		output = '"infrastructure:asphalt_arrow_right" 9',
		recipe = {
			{'infrastructure:asphalt', 'infrastructure:asphalt', 'infrastructure:asphalt'},
			{'infrastructure:asphalt', 'wool:white', 'wool:white'},
			{'infrastructure:asphalt', 'wool:white', 'infrastructure:asphalt'}
...
-- Asphalt block with "P"
	minetest.register_craft({
		output = '"infrastructure:asphalt_parking" 9',
		recipe = {
			{'infrastructure:asphalt', 'wool:white', 'wool:white'},
			{'infrastructure:asphalt', 'wool:white', 'wool:white'},
			{'infrastructure:asphalt', 'wool:white', 'infrastructure:asphalt'}
