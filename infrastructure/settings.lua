...
-- Traffic lights
	...
	TRAFFIC_LIGHTS_VOLUME = 0.1			-- a float		-> default = 0.1	| How noisy should be the beep sound?
...
-- Boom barrier
	...
	BOOM_BARRIER_VOLUME = 0.1			-- a float		-> default = 0.1	| How noisy should be the mechanism sound?

-- Curve chevron
	CURVE_CHEVRON_LIGHT_RANGE = 12			-- an integer		-> default = 12		| How much light do you want it to give?

-- Crosswalk lighting
	CROSSWALK_LIGHTING_LIGHT_RANGE = 13		-- an integer		-> default = 15		| How much light do you want it to give?
...
-- Aircraft warning light
	AIRCRAFT_WARNING_LIGHT_LIGHT_RANGE = 13		-- an integer		-> default = 15		| How much light do you want it to give?
-- Warning light
	WARNING_LIGHT_LIGHT_RANGE = 13			-- an integer		-> default = 15		| How much light do you want it to give?
