...
lapis.register_column("lapis", "lapisblock",
   {cracky=3},
...
lapis.register_column("lapis", "lazurite",
   {cracky= 3},
   {"lapis_lazurite_side.png",  "lapis_lazurite_side.png",  "lapis_lazurite.png^[transformFXR90",  "lapis_lazurite.png^[transformFX",  "lapis_lazurite.png^[transformFYR90",  "lapis_lazurite.png"},
   "Lazurite"
)
