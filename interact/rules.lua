...
6. Do not ask for more privs, or to be an admin.
7. Do not flood in the chat.
...
Recomendations:
Please create beautiful buildings.
_____________________________________
For more informations go to http://espclan.ru
]]

--The questions on the rules, if the quiz is used.
--The checkboxes for the first 4 questions are in config.lua
interact.s4_question1 = "Griefing is allowed?"
interact.s4_question2 = "Hacked clients is allowed?"
...
interact.s4_multi2 = "I WANT TO BREAKE THE MAP!!1!"
