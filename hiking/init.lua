...
minetest.register_alias("hiking:"..colour.."_sign", "hiking:illuminated_"..colour.."_sign")
minetest.register_alias("hiking:"..colour.."_arrow_right", "hiking:illuminated_"..colour.."_arrow_right")
minetest.register_alias("hiking:"..colour.."_arrow_left", "hiking:illuminated_"..colour.."_arrow_left")

minetest.register_alias("hiking:"..colour.."_pole_top", "hiking:illuminated_"..colour.."_pole_top")
minetest.register_alias("hiking:"..colour.."_pole_bottom", "hiking:illuminated_"..colour.."_pole_bottom")
...
local function mk_hiking_pole_illuminated_coloured(colour)
	mk_hiking_pole("illuminated_"..colour.."_pole", "Illuminated pole sign "..colour, "hiking_pole_sign_top_"..colour..".png", illuminated_props, "hiking_pole_sign_"..colour..".png")

end

minetest.register_alias("hiking:pole_top", "air")
minetest.register_alias("hiking:pole_bottom", "air")
minetest.register_alias("hiking:illuminated_pole_bottom", "air")
minetest.register_alias("hiking:illuminated_pole_top", "air")
minetest.register_alias("hiking:tall_pole_top", "air")
minetest.register_alias("hiking:tall_pole_middle", "air")
minetest.register_alias("hiking:tall_pole_bottom", "air")
minetest.register_alias("hiking:very_tall_pole_top", "air")
minetest.register_alias("hiking:very_tall_pole_middle", "air")
minetest.register_alias("hiking:very_tall_bottom", "air")
